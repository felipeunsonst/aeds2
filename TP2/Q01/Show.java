...
public class Show {
    ...
    public static void lerCSV() {
        ...
        String caminhoArquivo = "DisneyPlus.csv"; // Caminho do arquivo CSV
      ...
      for (int i = 0; i < ids.size(); i++) {
		    Show show = buscarPorID(ids.get(i), caminhoArquivo);
		    if (show != null) {
		        show.imprimir();
		    } else {
		        System.out.println("Show ID '" + ids.get(i) + "' não encontrado.");
		    }
		}
